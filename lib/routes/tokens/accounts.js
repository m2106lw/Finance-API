...
*/
accounts.get("/account/:account_id", asyncHandler(async (req, res, next) => {
	logAPICall(req.baseUrl + req.route.path, req.decoded.user_id);
...
*/
accounts.put("/account/:account_id", asyncHandler(async (req, res, next) => {
	logAPICall(req.baseUrl + req.route.path, req.decoded.user_id);
...
@apiParam {Number} :account_id ID of the Account to update
*/
accounts.delete("/account/:account_id", asyncHandler(async (req, res, next) => {
	logAPICall(req.baseUrl + req.route.path, req.decoded.user_id);
