...
**/
transaction.get("/getTransactionsByYear", function(req, res) {
...
@apiParam {Number} user_id User's ID
**/
transaction.get("/getTransactionsYears", function(req, res) {
	logAPICall(req.baseUrl + req.route.path);
	var userId = req.query.user_id; // Need to grab from token
...
**/
transaction.post("/postTransaction", function(req, res) {
	logAPICall(req.baseUrl + req.route.path);
...
**/
transaction.delete("/deleteTransaction", function(req, res) {
	logAPICall(req.baseUrl + req.route.path);
	var userId = req.query.user_id; // Need to grab from token
