...
*/
accounts.get("/getAccounts", asyncHandler(async (req, res, next) => {
...
*/
accounts.get("/getAccount", asyncHandler(async (req, res, next) => {
	logAPICall(req.baseUrl + req.route.path);
...
*/
accounts.post("/postAccount", asyncHandler(async (req, res, next) => {
	logAPICall(req.baseUrl + req.route.path);
